...
public class ProductoController {
    static final String VIEW_INDEX ="producto/index";
    static final String VIEW_CREATE="producto/create"; 
    static final String VIEW_EDIT="producto/edit"; 
    static String MODEL_PRODUCTO="producto";
